            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-4 text-center small">
                                        <span class="mr-2 ">
                                            <i class="fas fa-circle text-primary verde"></i> Aceptadas
                                        </span>
                        <span class="mr-2 ">
                                            <i class="fas fa-circle text-success rojo"></i> Denegadas
                                        </span><br>
                        <span class="mr-2 ">
                                            <i class="fas fa-circle text-info naranja"></i> En espera
                                        </span>
                        <span class="mr-2 ">
                                            <i class="fas fa-circle text-info gris"></i> Creadas
                                        </span>
                    </div>
                </div>
            </div>
