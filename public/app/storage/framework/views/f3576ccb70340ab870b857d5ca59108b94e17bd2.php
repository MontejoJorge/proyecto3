...
<head>
    ...
    <title><?php echo $__env->yieldContent('titulo'); ?> - Ayuntamiento Vitoria</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <div class="custom-control custom-switch" style="margin-top: 25px">
                        <label  style="margin-right: 38px" for="darkSwitch"><i class="far fa-sun"></i></label>
            ...
            <div class="container-fluid">
                <?php echo $__env->yieldContent('contenido', 'ERROR'); ?>
